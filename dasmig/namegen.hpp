...
namespace dasmig
{
    ...
    public:
        ...
        public:
            ...
            name append_name()
            {
                _internal_string.append(L" ").append(ng::instance().get_name(_gender, _culture));
                return *this;
            }
            ...
            {
                _internal_string.append(L" ").append(ng::instance().get_name(_gender, culture));
                return *this;
            }
            ...
            name append_surname()
            {
                _internal_string.append(L" ").append(ng::instance().get_surname(_culture));
                return *this;
            }
            ...
            {
                _internal_string.append(L" ").append(ng::instance().get_surname(culture));
                return *this;
            }
